...
extension Category {
    // Remove mainCategoryId: 1 from the first part
    static let autoAndTransport = Category(id: 1, name: "Auto & Transport", icon: .car_alt, mainCategoryId: 1)
    static let billsAndUtilities = Category(id: 2, name: "Bills & Utilities", icon: .file_invoice_dollar, mainCategoryId: 1)
    static let entertainment = Category(id: 3, name: "Entertainment", icon: .file_invoice_dollar, mainCategoryId: 1)
    static let feesAndCharges = Category(id: 4, name: "Fees & Charges", icon: .hand_holding_usd, mainCategoryId: 1)
    static let foodAndDining = Category(id: 5, name: "Food & Dining", icon: .hamburger, mainCategoryId: 1)
    static let home = Category(id: 6, name: "Home", icon: .home, mainCategoryId: 1)
    static let income = Category(id: 7, name: "Income", icon: .dollar_sign, mainCategoryId: 1)
    static let shopping = Category(id: 8, name: "Shopping", icon: .shopping_cart, mainCategoryId: 1)
    static let transfer = Category(id: 9, name: "Transfer", icon: .exchange_alt, mainCategoryId: 1)
    ...
    static let restourants = Category(id: 501, name: "Restourants", icon: .utensils, mainCategoryId: 5)
